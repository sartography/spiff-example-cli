...
from .user_input import Field, SimpleField
...
step_view = {"state": TaskState.ANY_MASK, "spec_name": None, "updated_ts": 0}


class TaskStateField(Field):
    def to_str(self, value):
        return TaskState.get_name(value)

    def from_str(self, value):
        return TaskState.get_value(value)
...
class TaskFilterView:
    ...
    def show(self, task_filter):
        ...
        user_input.fields = [
            ...
            TimestampField(
                "updated_ts", "Updated on or after", task_filter["updated_ts"]
            ),
        ]
